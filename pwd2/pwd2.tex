...
\subsection{liniowe}
Rozważmy wielomiany postaci \(p(x,y)=dx + ey + f\), gdzie \(d,e,f \in Z\).
...
\begin{definition}
    ...
    Gdy przeczyta `c' przechodzi do stanu \(q_1\).

    W stanie \(q_1\) z każdą literką `a' zdejmuje ze stosu jedno `l'.
