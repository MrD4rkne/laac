...
\begin{proof}
    ...
    To znaczy, że istnieje bieg \( \left(q_{1,1}, q_{2,1}, 0 \right) \xrightarrow{a_1} \left(q_{1,2}, q_{2,2}, 1 \right)
     \xrightarrow{a_2} \ldots \xrightarrow{a_n} \left(q_{1,n+1}, q_{2,n+1}, \left[ n \equiv 1 \mod 2  \right] \right) \). Zaczynamy w stanie \(\left( q_1, q_2, 0 \right)\).
    ...
    Zatem na mocy indukcji wiemy, że istnieją słowa \(b_1 b_2 \ldots b_n \in K, c_1 c_2 \ldots c_n \in L\) takie, że
    \( \forall_{i \in \{1,2,\ldots n\}} d_i = 3 \left( \implies a_i = b_i = c_i \right) \land d_i = 1/2 \implies b_i/c_i = w_i\).
