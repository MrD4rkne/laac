...
%         \node[state, initial] (q_00)   {$q_{0,1}$};
%         \node[state] (q_01) [above of=q_00] {$q_{0,2}$};

%         \node[state] (q_10) [right of=q_00] {$q_{1,1}$};
%         \node[state] (q_11) [above of=q_10] {$q_{1,2}$};

%         \path[->]
%             (q_00) edge node {a} (q_01)
%             (q_01) edge [bend left] node {a} (q_00)
%             (q_00) edge node {b} (q_10)

%             (q_10) edge node {a} (q_11)
%             (q_11) edge [bend left] node {a} (q_10);
%     \end{tikzpicture}
% \end{center}
